 ...
 * @returns {Array} nombres de alumnos
 */
...
/**
 * @description Funcion que nos devuelve un objeto alumno, buscamos por nombre. Si no encuentra nos devuelve null
 ...
 * @param {Object} alumno Objeto de tipo de alumno
 * @returns {Nombre} nombre completo del alumno que recibimos
 */
 ...
 * @param {Array} listaAlumnos Array de una lista de alumnos 
 * @returns {Array} alumnos que pertenecen a un determinado curso
 */
 ...
 * @param {Array} listaAlumnos Array de una lista de alumno
 * @returns {Array} Objeto que devuelve los alumnos matriculados en una asignatura 
 */
